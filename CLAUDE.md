...
| **6** | **X (Twitter)** | **https://x.com/SoothingSoothin** | **2026-05-30 GitHub Actions cron 月 180 投稿稼働中。 URL なしテンプレ10 種、 月 $2.70 (Pay Per Use)。 banner=案 B 墨絵 zen / avatar=案 C 兜 / 全媒体統一 (`assets/x_branding/design_spec_unified.md`)** |
