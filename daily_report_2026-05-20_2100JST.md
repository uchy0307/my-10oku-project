...
> ハンドル正は `@otona_psychology`（タスク指示文の `@otona_no_psychology` は typo・404）
...
- 🔎 夜枠（19:00 JST）otona_psychology の upload 有無確認
...
- Chrome MCP 切断のため、19:00 以降の otona_psychology チャンネル UI 上の最新 upload が直接確認できていない
