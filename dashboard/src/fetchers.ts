...
type NoteApiContents = { data?: { contents?: Array<{ key?: string; id?: number | string; name?: string; publishAt?: string; noteUrl?: string; type?: string; price?: number; body?: string; description?: string; eyecatch?: string; attachmentCount?: number; }>; }; };
...
export async function fetchNote(): Promise<FeedItem[]> {
    ...
    return contents
      ...
      .map<FeedItem>((c) => ({
              ...
              attachmentCount: typeof c.attachmentCount === "number" ? c.attachmentCount : undefined,
              bodyText: (typeof c.body === "string" ? c.body : (typeof c.description === "string" ? c.description : undefined))
      }));
}
