...
TEMPLATES = [
    ...
    # 江戸庶民バズ系 (好奇心フック → 歴史 YT 送客) ── ど真ん中の旗艦テーマ
    "江戸の離婚率は、実は現代より高かった。\n『三行半』の本当の意味、知っていますか?\n続きはプロフィールの歴史侍チャンネルで。\n#江戸時代 #日本史",
    "江戸時代、糞尿は『買い取られる』貴重な資源だった。\n世界一クリーンだった大江戸のリサイクル経済とは。\nプロフィールから歴史侍 ch へ。\n#江戸時代 #雑学",
    "蕎麦一杯十六文。\n江戸の物価から見えてくる、庶民のリアルな暮らし。\nプロフィールの歴史侍チャンネルで解説。\n#江戸時代 #日本史",
    "江戸は世界一の『独身男だらけ』の街だった。\nなぜ男が余り、女が足りなかったのか?\n続きはプロフィールから。\n#江戸時代 #歴史",
    "あなたが江戸時代に生まれていたら、何の職業?\n無料の侍タイプ診断で、あなたの中の武将もわかる。\nプロフィール固定リンクから ▶\n#侍タイプ診断 #江戸時代",
    "教科書のウソ──『鎖国』は、本当はなかった。\n開かれていた四つの窓口とは。\nプロフィールの歴史侍チャンネルで。\n#日本史 #江戸時代",

    # 診断系 (シェア拡散エンジン)
    "あなたは戦国武将なら誰?\n8つの問いで、あなたの中の侍を診断。結果をシェアしよう。\nプロフィール固定リンクから ▶\n#侍タイプ診断 #戦国",
    "あなたの恋愛偏差値は、いくつ?\n10問でわかる、あなたの恋の戦闘力。\nプロフィールの無料診断から ▶\n#恋愛偏差値診断 #恋愛心理",
